package com.ivy.ivyengine.constdefines;
...
public class IvyMessages {
    ...
    //
    public static boolean sendMessageIntent(Context context, int messageType, int messageState, int id,
    ...
    public static void sendGroupMessageIntent(Context context, int messageType, int messageState, int id,
    ...
    public static boolean sendNetworkStateChange(Context context, int connectionType, int state, String id) {
    ...
    public static boolean sendNetworkFinishScanIvyRoom(Context context) {
    ...
    public static boolean sendNetworkClearIvyRoom(Context context) {
        Intent intent = new Intent(IvyMessages.INTENT_NETWORK_FINISHSCANIVYROOM);
    ...
    public static boolean sendNetworkDiscoveryWifiP2p(Context context) {
