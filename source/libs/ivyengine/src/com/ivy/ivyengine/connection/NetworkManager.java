package com.ivy.ivyengine.connection;
...
import com.ivy.ivyengine.connection.implement.ConnectionManagement;
import com.ivy.ivyengine.connection.implement.ConnectionStateListener;
...
public class NetworkManager implements ConnectionStateListener {
    ...
    public NetworkManager(Context context) {
        ...
        if (!mConnectionManagement.initialize(context)) {
        ...
        if (mConnectionManagement != null) {
            ...
            if (state != ConnectionState.CONNECTION_UNKNOWN) {
                ...
                IvyMessages.sendNetworkStateChange(mContext, ConnectionState.CONNECTION_UNKNOWN, state, ssid);
            }
...
/*
    ...
    public boolean connectToWifiP2pPeer(String peerID) {
        ...
        if (re) {
            IvyMessages.sendNetworkStateChange(mContext,
...
//==============================================================================
    ...
    public void onAirplaneModeChanged(boolean enabled) {
        if (enabled) {
        	...
        	if (type == ConnectionState.CONNECTION_TYPE_HOTSPOT) {
                IvyMessages.sendNetworkStateChange(mContext, type, ConnectionState.CONNECTION_STATE_HOTSPOT_DISABLED, null);
        	} else if (type == ConnectionState.CONNECTION_TYPE_WIFI) {
        		IvyMessages.sendNetworkStateChange(mContext, type, ConnectionState.CONNECTION_STATE_WIFI_DISABLED, null);
        	}
        }
    }
    ...
    public void onWifiConnected(AccessPointInfo info) {
        ...
        IvyMessages.sendNetworkStateChange(mContext, ConnectionState.CONNECTION_TYPE_WIFI, state, info.getSSID());
    }
    ...
    public void onWifiDisconnected(String disconnectedSSID, int connectionType, int wifiState) {
        ...
        IvyMessages.sendNetworkStateChange(mContext, connectionType, wifiState, disconnectedSSID);
    }
    ...
    public void onWifiHotspotStateChanged(int connectionType, int state) {
    	...
    	String ssid= mConnectionManagement.getConnectionInfo().getSSID();
        IvyMessages.sendNetworkStateChange(mContext, connectionType, state, ssid);
    }

    @Override
    public void onScanResultAvailable(ArrayList<AccessPointInfo> lists) {
        updateScanResult(lists, mScanResult);
        IvyMessages.sendNetworkFinishScanIvyRoom(mContext);
    }
    ...
    public void onIvyHotspotIPAvailable(InetAddress addr) {
        ...
        String ssid= mConnectionManagement.getConnectionInfo().getSSID();
        IvyMessages.sendNetworkStateChange(mContext, ConnectionState.CONNECTION_TYPE_HOTSPOT,
    ...
    public void onWifiP2pConnected(AccessPointInfo info, String connectedPeerID) {
        ...
        IvyMessages.sendNetworkStateChange(mContext, ConnectionState.CONNECTION_TYPE_WIFIP2P,
    ...
    public void onWifiP2pStateChanged(String id, int connectionType, int state) {
        ...
        IvyMessages.sendNetworkStateChange(mContext, connectionType, state, id);
    }
    ...
    public void onWifiP2pDiscoveredList(ArrayList<AccessPointInfo> lists) {
        ...
        IvyMessages.sendNetworkDiscoveryWifiP2p(mContext);
    }
    ...
    public void onWifiDisabled() {
        ...
        IvyMessages.sendNetworkStateChange(mContext, ConnectionState.CONNECTION_TYPE_WIFI,
        		ConnectionState.CONNECTION_STATE_WIFI_DISABLED, null);
        IvyMessages.sendNetworkClearIvyRoom(mContext);
    }
