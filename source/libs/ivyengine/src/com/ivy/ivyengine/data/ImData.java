package com.ivy.ivyengine.data;
...
public class ImData {
    ...
    private void init(Context context) {
        ...
        mDataHelper = new ImDataHelper(context, IvyConfig.getInstance().getDataName(), null, VERSION);
    ...
    public synchronized Cursor getFreeShareHistory() {
        ...
        String []colums = {"*"};
        String order = Table_Share.TIME + " desc";
        Cursor cursor = mDatabase.query(Table_Share.TABLE_NAME, colums, null, null, null , null, order);
        return cursor;
    }
