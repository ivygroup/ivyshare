...
import com.ivy.ivyengine.utils.CommonUtils;
...
public class TranslateFileControl {
    ...
    public TranslateFileControl(Context context, ImData imData, PersonMessages personMessages, GroupMessages groupMessages) {
    	mContext = context;
    ...
    public synchronized boolean endReceiveFile(Person from, String id, String name, FileType fileType) {
        ...
        if (fileType.ordinal() == FileType.FileType_OtherFile.ordinal()) {
            ...
            MediaScannerConnection.scanFile(mContext, new String[] {path}, new String[] {null},
                    new OnScanCompletedListener() {
                        ...
                        public void onScanCompleted(String path, Uri uri) {
                            ...
                            if (newFileType.ordinal() != FileType.FileType_OtherFile.ordinal()) {
                                ...
                                ContentProviderClient mediaProvider = mContext.
                                ...
                                MediaScannerConnection.scanFile(mContext, // re-scan file
                                		new String[] {newFilePath}, new String[] {null}, null);
                            }
                            IvyMessages.sendMessageIntent(mContext, IvyMessages.VALUE_MESSAGETYPE_UPDATE, 
            ...
            IvyMessages.sendMessageIntent(mContext, IvyMessages.VALUE_MESSAGETYPE_UPDATE, Table_Message.STATE_OK, newId, fileType.ordinal(), path, false, from);
        }
        return true;
    }
    ...
    public synchronized boolean removeReceiveFileTaskOnly(String id, String name) {
        ...
        IvyMessages.sendMessageIntent(mContext, IvyMessages.VALUE_MESSAGETYPE_UPDATE, Table_Message.STATE_FAILED, newId, -1, name, false, null);
    ...
    public synchronized boolean removeReceiveGroupFileTaskOnly(boolean isBroadcast, String groupName, String id, String name) {
        ...
        IvyMessages.sendGroupMessageIntent(mContext, IvyMessages.VALUE_MESSAGETYPE_UPDATE, Table_Message.STATE_FAILED, 
    ...
    public synchronized boolean endReceiveGroupFile(boolean isBroadcast, String groupName, Person from, 
        ...
        if (fileType.ordinal() == FileType.FileType_OtherFile.ordinal()) {
            ...
            MediaScannerConnection.scanFile(
            		mContext, new String[] {path}, new String[] {null},
                    new OnScanCompletedListener() {
                        @Override
                        public void onScanCompleted(String path, Uri uri) {
                            Log.d(TAG, "onScanCompleted " + path + " uri " + uri);
                            ...
                            IvyMessages.sendGroupMessageIntent(mContext, IvyMessages.VALUE_MESSAGETYPE_UPDATE, Table_Message.STATE_OK, 
            ...
            switch (fileType) {
                ...
                case FileType_Music:
                case FileType_Video: {
                    MediaScannerConnection.scanFile(mContext, new String[] {path}, new String[] {null}, null);
                }
                break;
            }
