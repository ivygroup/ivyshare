...
public class SimplePopMenu implements OnItemClickListener {
    ...
    public void show(View parent) {
        mPopupWindow.showAtLocation(parent, Gravity.LEFT|Gravity.BOTTOM, 0, parent.getHeight()+40);//   .showAsDropDown(parent, mContext.getResources()
                //.getDimensionPixelSize(R.dimen.popmenu_xoffset), parent.geth);
