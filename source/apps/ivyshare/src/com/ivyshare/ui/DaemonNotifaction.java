...
import com.ivy.ivyengine.control.GroupMessages;
import com.ivy.ivyengine.control.LocalSetting;
import com.ivy.ivyengine.control.PersonManager;
import com.ivy.ivyengine.control.PersonMessages;
...
public class DaemonNotifaction implements DaemonNotifactionInterface {
    ...
    public DaemonNotifaction(Context context, ImData imData, PersonMessages personMessages, GroupMessages groupMessages) {
        mContext = context;
